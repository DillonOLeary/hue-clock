...
class TimeTrackingTest(unittest.TestCase):
    ...
    def test_rollover_across_two_midnights(self):
        ...
        self.app.record_clock_state(False, at(1, day=day3))
    ...
    def test_strike_span_reduces_worked_time(self):
        self.app.record_clock_state(True, at(9))
        self.app.record_clock_state(False, at(12))
    ...
    def test_events_survive_a_restart(self):
        ...
        first.record_clock_state(True, at(9), Provenance.RECONCILED)
